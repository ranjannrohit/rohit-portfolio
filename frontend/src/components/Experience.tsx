  ...
  const experiences = [
    {
      ...
      location: "Remote",
      description:  "Data Visualization, Business Intelligence, Dashboard Design, Analytical Reporting",
      achievements: [
        "Designed interactive dashboards using Power BI to visualize business metrics, trends, and performance indicators for decision support.",
  "Cleaned, transformed, and modeled datasets using Excel and SQL to ensure data accuracy and consistency across reports.",
  "Performed exploratory data analysis (EDA) to identify insights, patterns, and anomalies within structured datasets.",
  "Presented analytical findings through clear visual storytelling, improving stakeholder understanding and data-driven decisions.",
      ],
      color: "violet",
      icon: "/uploads/tata.png",
    ...
    },
    {
      ...
      description: "Data Analytics, Reporting, Dashboard Development, Institutional Insights",
      achievements: [
        "Analyzing ongoing student placement and internship data to identify trends, gaps, and performance metrics across departments.",
  "Designing and maintaining interactive dashboards in Excel and Power BI for real-time tracking of placements, offers, and recruiter participation.",
  "Cleaning, validating, and structuring large student datasets to ensure accuracy and consistency in institutional reports.",
  "Supporting placement coordinators and faculty with data-driven insights to improve student eligibility mapping and placement strategy.",
      ],
      color: "pink",
    ...
    },
    {
      ...
      location: "Remote",
      description: "Data Analytics, Data Cleaning, Exploratory Data Analysis, Business Reporting",
      achievements: [
         "Collected, cleaned, and preprocessed structured datasets using Excel and Python to ensure data accuracy and consistency.",
  "Performed exploratory data analysis (EDA) to identify trends, patterns, and key insights supporting business decision-making.",
  "Created analytical reports and visualizations to communicate findings effectively to technical and non-technical stakeholders.",
      ],
      color: "cyan",
